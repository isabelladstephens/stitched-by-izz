      ...
      <main className={styles.about_main}>
        <div className={styles.about_box}>
            ...
            <p className={styles.about_subtitle}>
                I&apos;m Isabella, an aspiring fashion designer and seamstress from Northern Utah. 
                I love having a creative outlet where I can wear the art I make. The interplay 
                of textures, colors, and forms allows me to craft not just garments, but story 
                narratives of style and self-expression. 
            </p>
            <p className={styles.about_subtitle}>
